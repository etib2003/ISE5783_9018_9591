...
public class Double3 {
    ...
    /**
     * Adds another Double3 to this Double3 and returns the result as a new Double3 object.
     * Each corresponding pair of numbers is added together.
     * 
	...
	/**
     * Subtracts another Double3 from this Double3 and returns the result as a new Double3 object.
     * Each corresponding pair of numbers is subtracted.
     * 
	...
	/**
     * Scales (multiplies) this Double3 by a scalar value and returns the result as a new Double3 object.
     * Each number is multiplied by the scalar value.
     * 
	...
	public Double3 scale(double rhs) {
	 ...
	 /**
     * Reduces (divides) this Double3 by a divisor value and returns the result as a new Double3 object.
     * Each number is divided by the divisor value.
     * 
	...
	/**
     * Multiplies another Double3 with this Double3 and returns the result as a new Double3 object.
     * Each corresponding pair of numbers is multiplied.
     * 
     ...
     * @return {@code true} if all the numbers are less than k, {@code false} otherwise
     */
	public boolean lowerThan(double k) {
	 ...
	 /**
     * Checks if all the numbers in this Double3 are lower than the corresponding numbers in another Double3.
     * 
     * @param other the other Double3 to compare with
     * @return {@code true} if all the numbers in this Double3 are less than the appropriate numbers in the other Double3,
     ...
     * @return {@code true} if this Double3 is the same as the obj argument; {@code false} otherwise
     */
	@Override
	...
	/**
     * Returns a string representation of this Double3.
     * The string representation consists of the three numbers enclosed in parentheses, separated by commas.
     * 
