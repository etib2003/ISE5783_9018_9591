...
class CylinderTest {
	...
	void getNormal() {
		...
		assertEquals(new Vector(-0.7071067811865476, 0.7071067811865476, 0.0),
				c1.getNormal(new Point(0, 1.414213562, 0)), "getNormal() wrong result");

		// TC02: Test that getNormal of Cylinder works
		assertEquals(new Vector(1, 1, 0).normalize(),
				c1.getNormal(new Point(3.5355339059327373, 3.5355339059327373, -0.5)), "getNormal() wrong result");
	...
	void findIntersectionsTest() {
		...
		// TC03: ray starts outside and parallel to the cylinder's ray and crosses the
		// cylinder
		...
		// TC15: ray is perpendicular to cylinder's ray and starts from inside cylinder
		// (not center)
		...
		// TC17: ray is perpendicular to cylinder's ray and starts from the surface of
		// cylinder to inside
		...
		// TC18: ray is perpendicular to cylinder's ray and starts from the surface of
		// cylinder to outside
