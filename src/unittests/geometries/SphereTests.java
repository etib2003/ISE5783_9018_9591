...
class SphereTests {
	...
	public void testFindIntersections() {
		...
		assertEquals(List.of(p2), sphere.findIntersections(new Ray(new Point(0.8, 0.6, 0), new Vector(3, 1, 0))),
		...
		assertEquals(List.of(p2), sphere.findIntersections(new Ray(p1, new Vector(3, 1, 0))),
		...
		assertEquals(List.of(new Point(2, 0, 0)),
				sphere.findIntersections(new Ray(new Point(0.5, 0, 0), new Vector(1, 0, 0))), "Ray starts inside ");
